...
public class LoginWithAdvancedXpath extends CommonMethods{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//identify username based on parent 
		...
		//identify login button based on parents previous siblings
		//WebElement loginBtn=driver.findElement(By.xpath("//div[@id='divLoginHelpLink']/following-sibling::div/input"));
		//click(loginBtn);
		
		//identify login button based on grandparent  //form[@id='frmLogin']/div[5]/input
